...
public class Show : StreamingContentEntity
{
    ...
    public Show(string title, string description, double starRating, 
    ...
    public Show(string title, string description, double starRating, 
        string location, MaturityRating maturityRating, GenreType genreType, List<Episode> episodes) : 
        base(title, description, starRating, location, maturityRating, genreType)
        {
            Episodes = episodes;
        }
